...
// A classe ReviewNotFoundAdvice existe para representar ou tratar um erro específico de forma controlada.
...
// Aqui o erro é convertido em HTTP 400, normalmente usado quando a requisição veio com formato ou valor inválido.
    ...
    String handleConversion(ReviewNotFoundException ex) {
